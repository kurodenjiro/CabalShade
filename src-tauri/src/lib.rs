        ...
        .invoke_handler({
            #[cfg(all(desktop, feature = "desktop-legacy"))]
            {
                tauri::generate_handler![
                    ...
                    commands::analyze_incoming_intent,
                    commands::respond_to_intent,
